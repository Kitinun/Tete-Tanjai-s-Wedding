...
export const translations = {
  th: {
    ...
    guestbook: {
      title: "Wishes for Us",
      subtitle: "ร่วมส่งคำอวยพร หรือความรู้สึกดีๆ ให้กับเราสองคน",
      button: "✍🏻 Leave a Wish",
      modalTitle: "Your Wish",
    ...
    rsvp: {
      title: "RSVP",
      subtitle1: "เพื่อความสะดวกต่อการจัดสรรและดูแลแขก",
      subtitle2: "รบกวนตอบกลับแบบฟอร์มนี้",
      nameLabel: "Name",
      namePlaceholder: "กรอกชื่อ - นามสกุล",
      guestsLabel: "Number of Guests",
      guests1: "1 ท่าน (Just me)",
      guests2: "2 ท่าน (Plus one)",
      guests3: "3 ท่าน",
      guests4: "4 ท่าน",
  ...
  en: {
    ...
    guestbook: {
      title: "Wishes for Us",
      subtitle: "Share your blessings and kind words with us",
      button: "✍🏻 Leave a Wish",
      modalTitle: "Your Wish",
    ...
    rsvp: {
      title: "RSVP",
      subtitle1: "To help us prepare and take care of everyone",
      subtitle2: "please kindly reply using this form.",
      nameLabel: "Name",
      namePlaceholder: "Enter your full name",
      guestsLabel: "Number of Guests",
      guests1: "1 Guest (Just me)",
      guests2: "2 Guests (Plus one)",
      guests3: "3 Guests",
      guests4: "4 Guests",
      attendanceLabel: "Attendance",
